...
private final ModelMapper modelMapper;
    ...
    public String  add(@Valid @ModelAttribute("exerciseBindingAddModel")
                    ExerciseBindingAddModel exerciseBindingAddModel, BindingResult bindingResult){
        return "exercise-add";
    }
    @PostMapping("/add")
    ...
    if(bindingResult.hasErrors()){
        ...
        //todo if date is between addedon and duedate
        this.exerciseService.addEx(this.modelMapper
                .map(exerciseBindingAddModel, ExerciseServiceModel.class));
        return "redirect:/";
    }
